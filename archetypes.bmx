...
'enemy 0 - "the box"
enemy_archetype[ 0] = Archetype_COMPLEX_AGENT( img_box, 50, 100, 200.0, 0.0, 0, 1, 2.0, 0.0 )
...
player_archetype[ 0] = Archetype_COMPLEX_AGENT( img_player_tank_chassis, 0, 500, 800.0, 40.0, 2, 2, 16.0, 32.0 )
