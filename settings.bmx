...
Function apply_default_settings()
	...
	SETTINGS_REGISTER.WINDOW_WIDTH = GLOBAL_SETTING_INTEGER.Create( 400 ) 'render resolution (fixed)
	SETTINGS_REGISTER.WINDOW_HEIGHT = GLOBAL_SETTING_INTEGER.Create( 300 ) 'render resolution (fixed)
	SETTINGS_REGISTER.ACTUAL_WINDOW_WIDTH = GLOBAL_SETTING_INTEGER.Create( 800 ) 'graphics resolution
	SETTINGS_REGISTER.ACTUAL_WINDOW_HEIGHT = GLOBAL_SETTING_INTEGER.Create( 600 ) 'graphics resolution
