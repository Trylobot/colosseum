...
Type PATH_QUEUE
	...
	Method insert%( i:CELL )
		debug_heap( "insert: (" + i.row + "," + i.col + ")" + " f:" + Int( pathing.f( i )) ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
		If item_count < max_size And Not in_queue( i ) 'if not full and item to be inserted is not already present in the queue
			...
			If Not is_empty()
				...
				debug_heap( "insert: up-sift" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
				...
				And Not f_less_than( binary_tree[item_parent_i], binary_tree[item_i] )
					...
					debug_heap( "insert: swap( i:"+item_i+", parent:"+item_parent_i+" )" )'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
					swap( item_i, item_parent_i ) 'swap item with its parent
					debug_heap( "insert: swap( i:"+item_i+", parent:"+item_parent_i+" ) success" )'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
			...
			debug_heap( "insert: success" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
			Return True 'successful insert
		Else
			debug_heap( "insert: failure" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
			Return False 'not enough room, or item to be inserted is not unique
		End If
	End Method
	
	Method pop_root:CELL()
		debug_heap( "pop_root" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
		If item_count > 0 'if not empty
			...
			If item_count >= 2 'if the root is not the only element
				debug_heap( "pop_root: down-sift" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
				...
				And Not f_less_than( binary_tree[item_i], binary_tree[child_i] )
					...
					debug_heap( "pop_root: swap( i:"+item_i+", child:"+child_i+" )" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
					swap( item_i, child_i ) 'swap item with its smallest child
					debug_heap( "pop_root: swap( i:"+item_i+", child:"+child_i+" ) success" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
			...
			End If
			item_count :- 1 'maintain size-tracking field
			debug_heap( "pop_root: success" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
			Return root 'extract the root and return it
		Else
			debug_heap( "pop_root: failure" ) 'DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG DEBUG 
