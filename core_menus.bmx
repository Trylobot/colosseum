...
Function initialize_menus()
	...
	Local menu_header_fg_font:BMP_FONT = get_bmp_font( "arcade_21" )
	Local menu_header_bg_font:BMP_FONT = get_bmp_font( "arcade_21_outline" )
	Local menu_item_fg_font:BMP_FONT = get_bmp_font( "arcade_14" )
	Local menu_item_bg_font:BMP_FONT = get_bmp_font( "arcade_14_outline" )
	Local menu_small_item_fg_font:BMP_FONT = get_bmp_font( "arcade_7" )
	Local menu_small_item_bg_font:BMP_FONT = get_bmp_font( "arcade_7_outline" )
