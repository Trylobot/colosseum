...
'the following assumes origin of (0,0)
Global common_walls:TList = CreateList()
'outer walls: N, E, S, W
common_walls.AddLast([ WALL_ADD, -arena_offset,-arena_offset, ((2*arena_offset)+arena_w)-arena_offset,0 ])
common_walls.AddLast([ WALL_ADD, arena_w,-arena_offset, 0,((2*arena_offset)+arena_h)-arena_offset ])
...
'the following assumes origin of (arena_offset,arena_offset)
